...
\begin{document}
    ...
    Tomando la idea de Markov (Muller, 2025), en algunas ocasiones prima la rigurosidad científica matemática y en su contraparte la creatividad. Esta última juega un papel importante en la historia y el desarrollo humano. Esto permite la gestación de ideas innovadoras, no limitándose a la matemática como mero artificio, sino como la herramienta capaz de construir y modelar eventos.
