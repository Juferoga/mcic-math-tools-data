...
del servicio (\textit{back-end}) encargadas de procesar la compra.
...
muchos procesos de llegadas de baja intensidad converge a un proceso Poisson. Mientras
ningún hincha individual domine el tráfico, el supuesto es razonable y defendible.
...
\emph{insensible} a la distribución del tiempo de servicio: solo necesita que la media
sea $1/\mu$.
...
\begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{plots/act_6_santafe/validacion_Clásico_Millonarios.png}
    \caption{Validación: Clásico Millonarios}
\end{subfigure}
\vspace{1em}
\begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{plots/act_6_santafe/validacion_Final_de_Copa.png}
    \caption{Validación: Final de Copa}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{plots/act_6_santafe/validacion_Súper-clásico.png}
...
Se ejecutó un simulador de eventos discretos (función \texttt{mmkk.m} del curso)
